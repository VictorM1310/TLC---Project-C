...
//Funcion para comprobar si hay errores con el simbolo de '='
void VerificaAsig(arregloChar2D *TokensLex,arregloInt2D *MTokLin, int *IAsign);

//Funcion para comprobar si hay errores con la palabra reservada IMPRIME
void VerificaImprime(arregloChar2D *TokensLex,arregloInt2D *MTokLin, int *IAsign);

//Funcion para comprobar si hay errores con los operadores 
void VerificaOperAr(arregloChar2D *TokensLex,arregloInt2D *MTokLin, int *IAsign);

//Funcion para comprobar si hay errores con los operadores relacionales
